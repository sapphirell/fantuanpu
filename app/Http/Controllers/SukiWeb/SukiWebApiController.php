...
class SukiWebApiController extends Controller
{
    ...
    public function add_suki_friend(Request $request)
    {
        ...
        $res = CommonApiController::_suki_send_friend_request(
    ...
    public function update_suki_user_info(Request $request)
    {
        ...
        {
            MemberFieldForumModel::update_field(
                $this->data['user_info']->uid,
                ["sightml" => $request->input("sightml")]
            );
        }
    ...
    public function suki_next_page(Request $request, Thread_model $thread_model)
    {
        ...
        return $request->input('need') == 'html' ? view("PC/Suki/SukiReply")->with(
            'data',
            ['thread_post' => $data, 'anonymous' => $anonymous]
        ) : self::response($data);
    }
