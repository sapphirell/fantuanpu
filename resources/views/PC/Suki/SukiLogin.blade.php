...
<div class="wp">
    <div class="">
        ...
        <div style="margin: 20px">
            <a id="old_user" style="    color: #fcadb9;" href="/old-user">忘记账户 / 密码?</a>
        ...
        <div class="bm_c">
            <form class="form-horizontal" role="form" action="/do-login" method="post">
                ...
                <button type="submit" class="btn  btn-info" style="background-color: #ffb6c7;background-image: linear-gradient(180deg, #fbded9 0%, #ffa5b2 93%);
                border: 0px;width: 55px;height: 55px;border-radius: 100%;
                    box-shadow: 0 3px 5px #ffe1e1;margin: 50px auto;    display: inherit;">登录</button>
