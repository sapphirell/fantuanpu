...
<div class="wp" style="margin-top: 60px;">
    ...
    border-radius: 5px;">
                ...
                <p>最低成团数:{{$item["count"]}} / {{$item["min_members"]}}个</p>
                ...
                @endforeach
                <br>
                <a href="/suki_group_buying_item_info?item_id={{$item["id"]}}" style="    margin-top: 10px;
    background: #f9c8c9;
    width: 100%;
    display: block;
    color: #fff;
    ...
    background-image: linear-gradient(90deg, #fbded9 0%, #ffa5b2 93%);">查看详情</a>
            </div>
